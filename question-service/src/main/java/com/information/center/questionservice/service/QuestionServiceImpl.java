...
public String getTopicNameByExternalId(String topicId) {
  ...
  public void update(QuestionResponse questionResponse) {
    QuestionEntity question = findById(questionResponse.getExternalId());
    QuestionEntity questionPersistent = questionConverter.toEntity(questionResponse, question.getId());
